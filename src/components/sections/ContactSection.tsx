            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-8 sm:gap-10">
              ...
              <div className="mt-4 self-start">
                <Magnet>
                  <button
                    type="submit"
                    className="rounded-full uppercase tracking-widest text-white font-medium px-10 py-4 text-sm sm:text-base hover:scale-105 transition-transform duration-300"
                    style={{
